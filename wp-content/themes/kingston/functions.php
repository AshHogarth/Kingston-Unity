<?php
update_option( 'siteurl', 'http://ku.wp.web.ai-staging.com' );
update_option( 'home', 'http://ku.wp.web.ai-staging.com' );
...
function bones_fonts() {
	wp_enqueue_style('googleFonts', 'https://fonts.googleapis.com/css?family=Karla:400,700|Lato:400,300,700');
}
